  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200 py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm text-gray-600">
        ...
        <div>
          <a 
            href="https://github.com/thatapicompany/overture-maps-world-places-demo" 
            target="_blank" 
            rel="noopener noreferrer"
